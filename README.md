...
| `github_username`          | mpapenbr                | used in go_module_path                                                                                                                                                                         |
...
| `license_owner`            | Markus Papenbrock       | Used in `LICENSE` and other files. Can be the name of a person or an organization.                                                                                                             |
...
| `use_devcontainer`         | **y**                   | Yes or No (`y` or `n`). Decides if [Devcontainer] config files should be created and configured                                                                                                |
| `go_version`               | `1.20`                  | The version of Go to use in the project. Can be either `1.20`, `1.19`                                                                                                                          |
